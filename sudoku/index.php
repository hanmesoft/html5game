...
/*
 ...
 Based upon sudoku generator from project ksudoku
  ...
  (c) 2007 Johannes Bergmeier <Johannes.Bergmeier@gmx.net>
	   ...
	   modified and translated by Hanmesoft Corporation < info@hanmesoft.net > in 2021. 6
*/
...
<html>
	<head>
		...
		<style type="text/css">
			...
			/* 한글폰트: 'Noto Sans KR Regular 400' */
			/* 영문폰트: 'Open Sans Regular 400' */
			/* 합쳐진 font-family 이름: 'Noto Sans KR' */
			@import url('https://combinefonts.hanmesoft.com/cssServer/combine?korFont=Noto%20Sans%20KR%20Regular%20400&engFont=Open%20Sans%20Regular%20400');
      ...
      //<![CDATA[
		var LangStrData = {
			...
			Kor: {
				label:	'Kor',
				  headTitle:	"스도쿠",
				  congratMsg: "성공하셨네요! 제대로 맞추셨습니다.\n한번 더 하시겠습니까?",
				  longCrtMsg: "<?=function_exists('fetchSudoku')?'새 퍼즐을 찾을 수 없네요. ':''?>새 퍼즐을 준비할 동안 잠시 기다려 주세요. 시간이 걸리네요.",
				  elementsID: {
					  fldBigTitle:	'숫자 넣기',
						...
						symmetryValue_2:	'대각선',
						symmetryValue_3:	'중앙',
						symmetryValue_4:	'네 방향',

						HighlightLbl:	'살짝 귀뜸하기',

						btn_clrAll:		'지우기',
						btn_probeAll:	'가능 숫자 표시',
						btn_clrPrAll:	'표시 모두 지우기',
						savingsLegend:	'상태',
						btn_saveCurState:	'저장하기',
						btn_restCurState:	'복원하기',

						pleaseDonateHndlr:	'즐기셨다면',
						pleaseDonateBody:	'기부도 고려해 주세요!'
					},
					inputsID: {
						submitInput:	'새로 하기'
					}
...
?>
  <div id="menu" class="menuDiv">
	...
	<button id="btn_clrAll"   onclick="clearAll();     return false;">Очистить</button>
	<button id="btn_probeAll" onclick="setAllProbes(); return false;">Отметить все варианты</button>
 ...
 <!-- href="javascript:void(null);" -->
  <div id="helpKor" style="display:none" class="helpHandler">
    <span id="KorHelpHandlerText">도움말</span>
    <div class="HelpBody">
      <p><span>스도쿠</span> - 는 논리 기반 숫자놀이입니다. Howard Garns 씨가 현대적 스도쿠를 1979년 Dell 잡지에 게재하였으며 1980년대 일본에서 인기를 끌었습니다. 2005년 전 세계적으로 크게 유행했다고 합니다.   위키피디아(http://en.wikipedia.org/wiki/Sudoku)</p>
      <p><span>놀이 목적</span>은 1부터 9까지 숫자를 네모 안에 채워 넣는 것입니다. 채우는 과정에서 서로 겹치지 않게 하는 것이 중요합니다. </p>
      <p><span>저자</span> Dmitry Y. Kazarov
      <a href="mailto:kazarov@users.sourceforge.net?subject=WebSudoku">write an E-mail</a>.</p>
		<p><span>한글화 및 수정</span> (주)한메소프트
      <a href="mailto:hanme@hanmesoft.net?subject=WebSudoku">이메일</a>.</p>
    </div>
  </div>
 ...
 <div class="LangChooser">
    언어/Language/Язык
    <span class="LangBody" >
      <input type="radio" name="languageSelector" value="Kor" onclick="changeLang(this);return true;"
	<?=$language=='Kor'?'checked="checked"':''?> />한국어<br />	
...
< ? } */ ?>
	<br><br>
  <div class="SFLogo"><a href="http://sourceforge.net/projects/websudoku"><img 	src="http://sflogo.sourceforge.net/sflogo.php?group_id=362437&amp;type=10" 	alt="Websudoku at SourceForge.net"></a> | <a href=http://play.hanmesoft.com target=_new>Play Hanmesoft!</a> | <a href=http://play.hanmesoft.com/html5game target=_new>HTML5 Game!</a> fonted by <a href=https://combinefonts.hanmesoft.com/ target=_new>Combine Fonts</a>!</div>
  <script type="text/javascript">
    //<![CDATA[
// debugger;
    var Cells = new Array(
